...
help:
	...
	@echo "make release.github             # create the changelog in https://github.com/tealbase/realtime/releases"
...
release.docker.%:
	...
	@echo "..."
	@echo "..."
	docker build . -t tealbase/realtime:$*
	docker push tealbase/realtime:$*