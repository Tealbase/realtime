...
<p align="center">
  <a href="https://tealbase.io">
        <picture>
      <img width="581" height="113" alt="tealbase" src="https://github.com/user-attachments/assets/53f4d27f-5d25-4d6c-aa58-2714e88679bc" />
  </a>
  ...
  <p align="center">
    ...
    <br />
    <br />
    <kbd><img src="./examples/next-js/demo.gif" alt="tealbase Realtime Demo"/></kbd>
  </p>
</p>
...
2. passing database changes to a [Write Ahead Log Realtime Unified Security (WALRUS)](https://github.com/tealbase/walrus) PostgresSQL function and receiving a list of authorized subscribers depending on Row Level Security (RLS) policies
...
- [Next.js example](https://github.com/tealbase/realtime/tree/main/examples/next-js)
- [NodeJS example](https://github.com/tealbase/realtime/tree/main/examples/node-js)
...
- C#: [@tealbase/realtime-csharp](https://github.com/tealbase/realtime-csharp)
...
```js
import { RealtimeClient } = '@tealbase/realtime-js'
...
- [@tealbase/realtime-js](https://github.com/tealbase/realtime-js) installed locally
...
2. Create a `PUBLICATION` for this server to listen to: `CREATE PUBLICATION tealbase_realtime FOR ALL TABLES;`
...
docker run                                                       \
  ...
  -e SLOT_NAME='tealbase_realtime'                               \
  -e PORT=4000                                                   \
  -e REALTIME_IP_VERSION='IPv6'                                  \
  -e PUBLICATIONS="[\"tealbase_realtime\"]"                      \
...
**Authorizing Client Connection**: You can pass in the JWT by following the instructions under **Usage** in the [@tealbase/realtime-js](https://github.com/tealbase/realtime-js) client library or as query param in the WebSocket URL (e.g. `wss://abc.tealbase.co/realtime/v1/websocket?vsn=1.0.0&apikey=jwt`).
...
- [Phoenix Channels Client](https://github.com/mcampa/phoenix-channels) - [@tealbase/realtime-js](https://github.com/tealbase/realtime-js) client library is ported from the Phoenix Channels Client library.
...
[new-sponsor-url]: https://github.com/sponsors/tealbase
[watch-repo-url]: https://github.com/tealbase/realtime/watchers
