...
function MyApp({ Component, pageProps }: AppProps) {
  return (
    <>
      <Head>
        <title>Realtime | tealbase</title>
        <link rel="icon" href="/favicon.ico" />
        <meta name="description" content="Presence and ephemeral state, by tealbase" />
        ...
        <meta property="og:title" key="ogtitle" content="Realtime | tealbase" />
        <meta
